...
public class Assets
{
    ...
    public final static String MUSIC_TEXTURE_BUTTON = "Close_BTN.png";
    public final static String SOUND_TEXTURE_BUTTON = "Close_BTN.png";
    ...
    private List<String> graphicsList = new ArrayList<String>(Arrays.asList(TILE_ONE, TILE_TWO, TILE_THREE, TILE_FOUR, TILE_HALF,
            ...
            PANEL, BACKGROUND_BLUE, BACKGROUND_AQUA, SCREEN_DARKENING, PAUSE_WINDOW, LOGO2, RESUME));
