...
public class Assets
{
    ...
    public final static String TILE_FINAL = "final.png";
    ...
    private List<String> graphicsList = new ArrayList<String>(Arrays.asList(BACKGROUND, TILE_ONE, TILE_TWO, TILE_THREE, TILE_FOUR,
            TILE_HALF, TILE_ZERO, TILE_START, TILE_FINAL, LASER, START_BUTTON, EXIT_BUTTON, RETURN_BUTTON,
            PAUSE_BUTTON, OK_BUTTON, CLOSE_BUTTON, FORWARD_BUTTON, BACKWARD_BUTTON, MUSIC_BUTTON, SOUND_BUTTON,
            NEXT_GAME_BUTTON, MENU_BUTTON, LEVEL_LOCKED, LEVEL_FINISHED, PANEL, TITLE, SELECT_LEVEL, YOU_WIN_TEXT, RESUME));
